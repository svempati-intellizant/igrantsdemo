...
function AgencyLevelAnalysis() {
  ...
  useEffect(() => {
    if (grantList) {
      setAgencyList(grantList.filter((x) => x.agency === agencytarget));
    }
  }, [grantList, agencytarget]);
  ...
  const gotoPage = (val) => {
    history.push(`/dashboard/portfolio/agency/${agencytarget}/${val}`);
  };
  ...
  return (
    <AgencyLevelAnalysisWrapper>
      {agencyList && overallRiskDetail && safRiskDetail && portfolio && (
        <>
          <Grid container spacing={3} justify="space-around" className="mt-5 mb-5">
            ...
            <Grid item xs={12} md={3} className="pullUp">
            ...
            <Grid item xs={12} md={5} className="pullUp">
            ...
            <Grid container spacing={6}>
              <Grid item xs={12} sm={6}>
                <div className="pullUp">
                  <Bar data={trend.compliance_risk} options={chartOptions}></Bar>
                </div>
              </Grid>
              <Grid item xs={12} sm={6}>
                <div className="pullUp">
                  <Bar data={trend.financial_risk} options={chartOptions}></Bar>
                </div>
              </Grid>
              <Grid item xs={12} sm={6}>
                <div className="pullUp">
                  <Bar data={trend.performance_risk} options={chartOptions}></Bar>
                </div>
              </Grid>
              <Grid item xs={12} sm={6}>
                <div className="pullUp">
                  <Bar data={trend.quality_risk} options={chartOptions}></Bar>
                </div>
              </Grid>
            </Grid>
          ) : (
